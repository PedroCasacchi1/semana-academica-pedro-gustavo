...
- R3. A rotacao do codigo QR ocorre a cada minuto, em intervalos alinhados ao relogio que comecam em `hh:mm:00` e terminam em `hh:mm:59`; `trocaEm` indica o inicio do minuto seguinte, enquanto `validoAte` indica o inicio do minuto posterior a ele. Origem: P-02. Fonte: RN-303.
